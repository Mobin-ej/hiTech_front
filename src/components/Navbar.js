  ...
  return (
    ...
    >
      <div className="relative flex h-16 items-center justify-between px-4">
        ...
        <button className="relative inline-block px-3 font-BNazanin  ml-4 py-1  text-[#4A628A] transition-all duration-300 border-2  bg-[#B9E5E8]  rounded-lg overflow-hidden group hover:bg-sky-400 hover:text-white hover:shadow-[0px_2px_0px_2px_rgba(13,59,102,1)] active:scale-90">
